...
#if !defined(PRANA_99FBA54B_F9AA_4FC6_B4BF_FE7A434D25AD)
#define PRANA_99FBA54B_F9AA_4FC6_B4BF_FE7A434D25AD

#include <sheol/adt/dynamic_array.hpp>

#include <prana/parse/grammar/string.hpp>
#include <prana/parse/error_handler.hpp>
#include <prana/parse/annotator.hpp>
...
typedef sheol::adt::dynamic_array<fusion::vector1<source_location> >
  sexpr_annotations;
...
template<class Tag, class Iterator>
struct sexpr_parser<Tag, Iterator, typename boost::enable_if<
...
> {
  ...
  qi::rule<Iterator, spirit::binary_string_type(void)>
    binary;
...
#endif // PRANA_99FBA54B_F9AA_4FC6_B4BF_FE7A434D25AD
