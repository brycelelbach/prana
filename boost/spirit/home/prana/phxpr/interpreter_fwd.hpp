...
#if !defined(BSP_PHXPR_INTERPRETER_FWD_HPP)
#define BSP_PHXPR_INTERPRETER_FWD_HPP
...
struct interpreter {
  ...
  interpreter (Source& in, std::string const& source = "<string>",
...
#endif // BSP_PHXPR_INTERPRETER_FWD_HPP
