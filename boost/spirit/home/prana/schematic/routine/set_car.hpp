...
#if !defined(BOOST_SPIRIT_PRANA_SCHEMATIC_ROUTINE_SET_CAR_HPP)
#define BOOST_SPIRIT_PRANA_SCHEMATIC_ROUTINE_SET_CAR_HPP
...
#endif // BOOST_SPIRIT_PRANA_SCHEMATIC_ROUTINE_SET_CAR_HPP
