...
#if !defined(BOOST_SPIRIT_PRANA_SEXPR_ROUTINE_CLEAR_FWD_HPP)
#define BOOST_SPIRIT_PRANA_SEXPR_ROUTINE_CLEAR_FWD_HPP
...
#endif /*<- BOOST_SPIRIT_PRANA_SEXPR_ROUTINE_CLEAR_FWD_HPP ->*/
