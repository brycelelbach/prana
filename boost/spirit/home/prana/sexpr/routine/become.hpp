...
#if !defined(BOOST_SPIRIT_PRANA_SEXPR_ROUTINE_BECOME_HPP)
#define BOOST_SPIRIT_PRANA_SEXPR_ROUTINE_BECOME_HPP
...
#endif /*<- BOOST_SPIRIT_PRANA_SEXPR_ROUTINE_BECOME_HPP ->*/
