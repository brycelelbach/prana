...
#if !defined(BOOST_SPIRIT_PRANA_SEXPR_ROUTINE_SET_CAR_HPP)
#define BOOST_SPIRIT_PRANA_SEXPR_ROUTINE_SET_CAR_HPP

#include <boost/spirit/home/prana/sexpr/routine/set_car_fwd.hpp>
...
//[set_car_definition
template<class Value>
inline sexpr*& set_car (sexpr& s, Value const& v) {
  return dispatch<sexpr::registry, routine::set_car, sexpr, Value const>(s, v);
}

inline sexpr*& set_car (sexpr& s, sexpr* const& v) {
  return dispatch<sexpr::registry, routine::set_car, sexpr, sexpr* const>(s, v);
}
//]
...
#endif /*<- BOOST_SPIRIT_PRANA_SEXPR_ROUTINE_SET_CAR_HPP ->*/
