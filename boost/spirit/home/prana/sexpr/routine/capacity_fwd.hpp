...
#if !defined(BOOST_SPIRIT_PRANA_SEXPR_PROCEDURE_CAPACITY_FWD_HPP)
#define BOOST_SPIRIT_PRANA_SEXPR_PROCEDURE_CAPACITY_FWD_HPP
...
#endif /*<- BOOST_SPIRIT_PRANA_SEXPR_PROCEDURE_CAPACITY_FWD_HPP ->*/
