...
#if !defined(BOOST_SPIRIT_PRANA_SEXPR_ROUTINE_CDR_FWD_HPP)
#define BOOST_SPIRIT_PRANA_SEXPR_ROUTINE_CDR_FWD_HPP
...
#endif /*<- BOOST_SPIRIT_PRANA_SEXPR_ROUTINE_CDR_FWD_HPP ->*/
