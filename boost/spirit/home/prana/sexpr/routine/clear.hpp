...
#if !defined(BOOST_SPIRIT_PRANA_SEXPR_ROUTINE_CLEAR_HPP)
#define BOOST_SPIRIT_PRANA_SEXPR_ROUTINE_CLEAR_HPP
...
#endif /*<- BOOST_SPIRIT_PRANA_SEXPR_ROUTINE_CLEAR_HPP ->*/
