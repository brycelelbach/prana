...
#if !defined(BOOST_SPIRIT_PRANA_VM_CORE_EXTERNAL_FUNCTION_HPP)
#define BOOST_SPIRIT_PRANA_VM_CORE_EXTERNAL_FUNCTION_HPP
...
#endif // BOOST_SPIRIT_PRANA_VM_CORE_EXTERNAL_FUNCTION_HPP
