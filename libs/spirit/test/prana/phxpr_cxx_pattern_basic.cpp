...
int main (void) { try {
  ...
  std::cout << "(basic-pattern-test" << std::endl; 
  ...
  std::cout << "(basic-variadic-pattern-test" << std::endl; 
  ...
  std::cout << "  )\n\n(variadic-pattern-greater-arity-test" << std::endl; 
  ...
  std::cout << "  )\n\n(variadic-pattern-lesser-arity-test" << std::endl; 
